...
const EnterScore: React.FC = () => {
  ...
  const scoreAtTopTen = () => {
    ...
    return (
      ...
      currentScores[currentScores.length - 1].score < scorePkt
    );
  };
        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content text-center flex-col gap-4">
            ...
            <div className="text-2xl">
              Leider habt ihr es nicht auf die Bestenliste geschafft
            </div>
            <div className="text-3xl">...</div>
            <div
              className={(activeIndex === 0 ? "bg-primary" : "") + " kbd mt-2"}
              onClick={confirmName}
            >
              Auf ein Neues!
            </div>
          ...
          <div className="hero-content text-left flex-col">
            ...
            <div className="text-center">
              <div className="flex gap-2 justify-center text-2xl ">
                ...
                <div>
                  {teamName}
                  <span className="blink-ani">{currentLetter}</span>
                </div>
              </div>
              <div>
                <div className={"p-4 text-center flex gap-2 justify-center"}>
                  ...
                  <span
                    className={
                      (activeIndex === 0 ? "bg-primary" : "") + " kbd text-2xl"
                    }
                  >
                    {currentLetter}
                  </span>
                ...
                <div className="flex gap-4 p-4 justify-center text-2xl">
                  <div
                    className={
                      "p-2 kbd " + (activeIndex === 1 ? "bg-primary" : "")
                    }
                  ...
                  <div
                    className={(activeIndex === 2 ? "bg-primary" : "") + " kbd"}
                    onClick={confirmName}
                  >
                    Bestätigen
                  </div>
